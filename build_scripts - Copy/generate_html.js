...
for(let i = 3; i < files.length; i++) {
  html += `            <div class="portfolio-item">
              <img src="team 360 fav pic/${files[i]}" alt="Bespoke Detail" class="portfolio-img" onerror="this.src='team-360-fav-pic/${files[i]}'">
            </div>\n`;
}
...
fs.writeFileSync('residential-grid.txt', html);
